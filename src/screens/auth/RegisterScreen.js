  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <LinearGradient colors={[COLORS.bgTop, COLORS.bgBottom]} style={styles.bg}>
        ...
        <Text style={[styles.heart, { top: 70, right: 28, fontSize: 14 }]}>♡</Text>
        <Text style={[styles.heart, { bottom: 86, right: 22, fontSize: 16 }]}>♡</Text>
        <Text style={[styles.heart, { bottom: 120, left: 26, fontSize: 13 }]}>♡</Text>
...
const styles = StyleSheet.create({
  ...
  socialRow: { flexDirection: "row", justifyContent: "center", gap: 14, marginBottom: 14 },
  socialBtn: {
    width: 44,
    height: 44,
    borderRadius: 14,
